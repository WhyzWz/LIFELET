...
(function() {
    ...
    // Se já houver sessão salva no localStorage, redireciona para central.html
        ...
        if (loginForm) {
            loginForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    setTimeout(() => window.location.href = 'central.html', 900);
        ...
        if (registerForm) {
            registerForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    setTimeout(() => window.location.href = 'central.html', 1200);
